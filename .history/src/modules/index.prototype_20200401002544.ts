...
interface Array<T> {
  merge(arr2: Array<any>): Array<any>;
  equal(arr2: Array<any>): boolean;
}
/**
 ...
 */
Array.prototype.merge = function(arr2: Array<any>): Array<any> {
 ...
 */
Array.prototype.equal = function(arr2: Array<any>): Boolean {
