 ...
 */
String.prototype.normal = (): String => {
 ...
 */
String.prototype.toHumanName = function(): Boolean {
  let temp = this.toLowerCase().split(' ');
 ...
 */
Array.prototype.merge = function(arr2: Array): Array {
