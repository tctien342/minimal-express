    ...
    switch (args[1]) {
      case "module": {
        if (args.length === 4) {
          ...
          console.log("> Usage: create module <module name> <module url>");
      ...
      default: {
        console.log("> Fast create component for express minimal project");
  ...
  lineReader.eachLine("src/modules/index.js", (line, last) => {
    ...
    if (lineFirstWord !== "import" && !imported) {
      ...
      if (
        ...
        outPutNew[outPutNew.length - 1] = outPutNew[outPutNew.length - 1] + ",";
      }
